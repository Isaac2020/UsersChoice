...
public class TimiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item("Chicken", BigDecimal.valueOf(500), R.drawable.chicken));
        ...
        items.add(new Item("Spagheti & Chicken", BigDecimal.valueOf(300), R.drawable.spackswithchicken));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Intent intent = new Intent(TimiActivity.this, CartActivity.class);
